...
type Client struct {
	...
	Multiplier   int64          `json:"multiplier" form:"multiplier"` // Traffic counting multiplier (1 = no scaling, 2 = 1MB counts as 2MB)
	ExpiryTime   int64          `json:"expiryTime" form:"expiryTime"` // Expiration timestamp
...
type ClientRecord struct {
	...
	Multiplier   int64  `json:"multiplier" gorm:"column:multiplier;default:1"`
